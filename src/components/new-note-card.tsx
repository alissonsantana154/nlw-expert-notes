...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  const [shouldShowOnboarding, setShowldShowOnboarding] = useState(true)
        ...
        <form className="flex-1 flex flex-col">
          ...
          {isRecording? (
            <button
              ...
              className="w-full flex flex-center justify-center gap-2 bg-slate-900 py-4 text-sm text-slate-300 outline-none font-medium hover:bg-slate-100"
            >
